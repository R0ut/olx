...
#pragma warning disable
    ...
    public partial class Client
    {
        ...
        public System.Threading.Tasks.Task SaveAdsAsync(System.Collections.Generic.IEnumerable<TableUser> data)
        {
            return SaveAdsAsync(data, System.Threading.CancellationToken.None);
        }
    ...
    public partial class TableUser
    {
        ...
        [Newtonsoft.Json.JsonProperty("dateOfCreation", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.DateTimeOffset? DateOfCreation { get; set; }

        [Newtonsoft.Json.JsonProperty("tableAd", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public TableAd TableAd { get; set; }

        [Newtonsoft.Json.JsonProperty("tableAdId", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        ...
        public static TableUser FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<TableUser>(data);
        }
    ...
    public partial class TableAd
    {
        ...
        [Newtonsoft.Json.JsonProperty("productionYear", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        ...
        [Newtonsoft.Json.JsonProperty("horsePower", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        ...
        [Newtonsoft.Json.JsonProperty("isDamaged", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public bool? IsDamaged { get; set; }

        [Newtonsoft.Json.JsonProperty("tableUser", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public TableUser TableUser { get; set; }

        [Newtonsoft.Json.JsonProperty("tableUserId", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        ...
        public static TableAd FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<TableAd>(data);
        }
